<footer class="bg-[#171717] py-4">
	<div class="container">
		<div class="flex flex-wrap items-center justify-center md:justify-between gap-y-5">
			<div class="w-full md:w-fit">
				<p class="text-white font-raleway text-xs md:text-base text-center md:text-start">Copyright <?= date('Y') ?> <span class="px-3 md:px-10">|</span> <?= $site ?> <span class="px-3 md:px-10">|</span> All Rights Reserved</p>
			</div>
			<div class="w-fit">
