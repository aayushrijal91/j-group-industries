            ...
            <div class="w-full md:w-1/2 lg:w-1/3 px-2">
                <article class="serviceCard">
                    ...
                    <article class="mx-[18px] mt-[-56px] text-center flex flex-col items-center justify-center text-white relative rounded-[20px] bg-primary h-[72px] md:h-[112px]">
                        ...
                        <a href="#form" class="font-raleway font-semibold text-sm md:text-base">Book Today</a>
                    </article>
                </article>
            </div>
            ...
            <article class="2xl:w-10/12 pt-10">
                ...
                <article class="accordion bg-light p-4 md:px-7">
                    ...
                    <article class="answer font-raleway text-quaternary pt-3">
                        <p>
                            The three main types of asbestos are Chrysotile (white asbestos), Crocidolite (blue asbestos) or Amosite (brown or grey asbestos).
                            Blue asbestos is known to cause the most harm because the fibres are relatively long and thin and able to reach the lungs more quickly than a curlier fibre.
                            Asbestos around the home is commonly found in walling lining sheets, ceiling linings, vinyl flooring, around fireplaces, in insulation and in carpet underlay.
                            Used in over 5000 products it would be difficult to name them all here!
                        </p>
                    </article>
                </article>
            </article>
        ...
        <div class="w-full lg:w-1/2 px-6 md:px-20 lg:px-6 xl:px-20 flex justify-end">
            <article class="2xl:w-10/12 md:pt-10">
                ...
                <article class="accordion bg-light p-4 md:px-7">
                    ...
                    <article class="answer font-raleway text-quaternary pt-3">
                        <p>
                            ...
                            Unfortunately, there are currently no laws or regulations pertaining to mould removal.
                            This means that anyone can call themselves a mould expert and sell solutions that only work for a short time. If you want the mould to stay gone, you need to call in the experts. At J Group Industries, we work in conjunction with Environmental Hygienists and Building Inspectors. This means that we can not only remove the mould but ascertain the source of the moisture problem so that any necessary repairs can be made to prevent the return of mould in your home.
                        </p>
                    </article>
                </article>
                ...
                <article class="accordion bg-light p-4 md:px-7 mt-3">
                    ...
                    <article class="answer font-raleway text-quaternary pt-3">
                        <p>
                            Mould can be black, grey-brown, grey-green or white in colour. It can appear as clusters of small black spots or can look white and thread-like.
